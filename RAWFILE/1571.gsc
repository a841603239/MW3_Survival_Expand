...
_id_3F67()
{
    ...
    thread mod_friendly_upgrade::main();
}
...
spawn_allies( var_0, var_1, var_2 )
{
    ...
    if ( var_1 == "friendly_support_delta" )
    {
        var_4 = 1; // Delta小队人数
    }
    else if ( var_1 == "friendly_support_riotshield" )
    {
        var_4 = 2; // GIGN防暴小队人数
    }
    else
    ...
    _id_061C::_id_3DE2( var_1, var_4, var_3, var_2 );
}
...
_id_3C63()
{
    ...
    var_1 = 196;
    if ( issplitscreen() )
        var_1 = 112 + ( self == level.player ) * 27;
    ...
    for ( var_4 = 0; var_4 < 2; var_4++ )
    {
        ...
        var_5.in_use = 0;
        var_5.perk_name = "";
        var_5.icon = _id_3FCF( var_0 + ( var_4 * var_3 ), var_1 );
        var_5.icon.alpha = 0.0;
        self.perk_huds[var_4] = var_5;
    }

    thread _id_3FC4_give();
    thread _id_3FC4_take();
}
...
_id_3FC4_give()
{
    ...
    for(;;)
    {
        ...
        foreach( var_2 in self.perk_huds )
        {
            if ( !var_2.in_use )
            {
                var_1 = level._id_3D68["airsupport"][var_0].icon;
                var_2.icon setshader( var_1, 28, 28 );
                var_2.icon.alpha = 0.85;
                var_2.in_use = 1;
                var_2.perk_name = var_0;
                break;
            }
        }
    }
...
_id_3FC4_take()
{
    ...
    for(;;)
    {
        ...
        foreach( var_1 in self.perk_huds )
        {
            if ( var_1.in_use && var_1.perk_name == var_0 )
            {
                var_1.icon.alpha = 0.0;
                var_1.in_use = 0;
                var_1.perk_name = "";
                break;
            }
